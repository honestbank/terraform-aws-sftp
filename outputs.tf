output "transfer_server_arn" {
  value = module.sftp.transfer_server_arn
}
...
output "transfer_storage_bucket_arn" {
  value = module.sftp.transfer_storage_bucket_arn
}

output "target_storage_bucket_name" {
  value = module.sftp.target_storage_bucket_name
}

output "target_storage_bucket_arn" {
  value = module.sftp.target_storage_bucket_arn
}
